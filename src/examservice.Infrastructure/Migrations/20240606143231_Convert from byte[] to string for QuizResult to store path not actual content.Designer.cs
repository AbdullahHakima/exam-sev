...
namespace examservice.Infrastructure.Migrations
{
    ...
    [Migration("20240606143231_Convert from byte[] to string for QuizResult to store path not actual content")]
    partial class ConvertfrombytetostringforQuizResulttostorepathnotactualcontent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("examservice.Domain.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("examservice.Domain.Entities.Quiz", b =>
                {
                    ...
                    b.Property<string>("QuizResultsPath")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("examservice.Domain.Entities.InstructorCourses", b =>
                {
                    b.HasOne("examservice.Domain.Entities.Course", "course")
                        .WithMany("InstructorCourses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("examservice.Domain.Entities.Instructor", "instructor")
                        .WithMany("InstructorCourses")
            ...
            modelBuilder.Entity("examservice.Domain.Entities.Module", b =>
                {
                    b.HasOne("examservice.Domain.Entities.Quiz", "Quiz")
                        .WithMany("Modules")
            ...
            modelBuilder.Entity("examservice.Domain.Entities.ModuleQuestion", b =>
                {
                    b.HasOne("examservice.Domain.Entities.Module", "Module")
                        .WithMany("ModuleQuestions")
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("examservice.Domain.Entities.Question", "Question")
                        .WithMany("ModuleQuestions")
            ...
            modelBuilder.Entity("examservice.Domain.Entities.StudentCourses", b =>
                {
                    ...
                    b.HasOne("examservice.Domain.Entities.Student", "student")
                        .WithMany("StudentCourses")
            ...
            modelBuilder.Entity("examservice.Domain.Entities.StudentQuizzes", b =>
                {
                    ...
                    b.HasOne("examservice.Domain.Entities.Submission", "submission")
                        .WithMany()
